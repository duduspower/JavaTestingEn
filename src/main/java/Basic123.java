...
public class Basic123 {
    public static void main(String[] args) {
        ...
        if(wynik1 < wynik2){
            if(wynik1 < wynik3){
                System.out.println("Najmniejszy wynik to wynik 1 i wynosi : " + wynik1);
            }
        }else if(wynik2 < wynik1){
            if(wynik2 < wynik3){
                System.out.println("Najmniejszy wynik to wynik2 i wynosi : " + wynik2);
            }
        }
        else{
            System.out.println("Najmniejszy wynik to wynik3 i wynosi : " + wynik3);
        }
    }
}
